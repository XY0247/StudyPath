...
public class EditTeacherServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        context.setVariable("editTeacher", teacherService.getTeacherById(req.getParameter("editTeacher")));
        ThymeleafUtil.process("EditTeacher.html",context,resp.getWriter());
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // 处理逻辑
        boolean updateSuccess = teacherService.updateTeacherWithObject(teacher);
